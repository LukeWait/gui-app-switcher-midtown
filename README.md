...
## User Manual
For detailed instructions on installation, setup, and usage, please refer to the [User Manual](https://github.com/LukeWait/gui-app-switcher-midtownapp/blob/main/midtownapp_user_manual.pdf).
